...
import { createFridgeItem } from '@/services/api';
...
export function AddProductScreen() {
  ...
  async function addToFridge() {
    ...
    if (!trimmedName) {
      Alert.alert('Missing item name', 'Add a product name before adding it to the fridge.');
      return;
    }
    ...
    <ScreenContainer>
      <KeyboardAvoidingView
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.eyebrow}>New fridge item</Text>
          <Text style={styles.description}>
            Choose the item details and save it to your fridge inventory.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.dateRow}>
            ...
            {expiresAt ? (
              <Pressable style={styles.clearDateButton} onPress={() => setExpiresAt('')}>
        ...
        <Pressable
          ...
          onPress={addToFridge}>
          <Text style={styles.submitButtonText}>{isSaving ? 'SAVING...' : 'ADD to fridge'}</Text>
        </Pressable>
        </ScrollView>
      </KeyboardAvoidingView>
